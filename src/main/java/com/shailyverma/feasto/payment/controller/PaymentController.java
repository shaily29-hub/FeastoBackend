package com.shailyverma.feasto.payment.controller;


import com.shailyverma.feasto.payment.dtos.PaymentDTO;
import com.shailyverma.feasto.payment.services.PaymentService;
...
public class PaymentController {
    ...
    public ResponseEntity<Response<?>> initializePayment(
            @RequestBody @Valid PaymentDTO paymentRequest) {

        return ResponseEntity.ok(paymentService.initializePayment(paymentRequest));
    }

    @PutMapping("/update")
    public void updateOrderAfterPayment(
    ...
    public ResponseEntity<Response<PaymentDTO>> getPaymentById(
